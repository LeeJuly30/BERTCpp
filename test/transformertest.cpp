...
TEST(CommonTest, transformer){
    Graph graph = {
            {"encoder/layer_0/attention/self/query/kernel",      new tensor(static_cast<void*>(query_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_0/attention/self/query/bias",        new tensor(static_cast<void*>(query_bias), vector<size_t>({6}))},
            {"encoder/layer_0/attention/self/key/kernel",        new tensor(static_cast<void*>(key_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_0/attention/self/key/bias",          new tensor(static_cast<void*>(key_bias), vector<size_t>({6}))},
            {"encoder/layer_0/attention/self/value/kernel",      new tensor(static_cast<void*>(value_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_0/attention/self/value/bias",        new tensor(static_cast<void*>(value_bias), vector<size_t>({6}))},
            {"encoder/layer_0/attention/output/dense/kernel",    new tensor(static_cast<void*>(attention_output_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_0/attention/output/dense/bias",      new tensor(static_cast<void*>(attention_output_bias), vector<size_t>({6}))},
            {"encoder/layer_0/attention/output/LayerNorm/beta",  new tensor(static_cast<void*>(attention_norm_beta), vector<size_t>({6}))},
            {"encoder/layer_0/attention/output/LayerNorm/gamma", new tensor(static_cast<void*>(attention_norm_gamma), vector<size_t>({6}))},
            {"encoder/layer_0/intermediate/dense/kernel",        new tensor(static_cast<void*>(intermediate_kernel), vector<size_t>({6, 12}))},
            {"encoder/layer_0/intermediate/dense/bias",          new tensor(static_cast<void*>(intermediate_bias), vector<size_t>({12}))},
            {"encoder/layer_0/output/dense/kernel",              new tensor(static_cast<void*>(output_kernel), vector<size_t>({12, 6}))},
            {"encoder/layer_0/output/dense/bias",                new tensor(static_cast<void*>(output_bias), vector<size_t>({6}))},
            {"encoder/layer_0/output/LayerNorm/beta",            new tensor(static_cast<void*>(output_norm_beta), vector<size_t>({6}))},
            {"encoder/layer_0/output/LayerNorm/gamma",           new tensor(static_cast<void*>(output_norm_gamma), vector<size_t>({6}))},
            {"encoder/layer_1/attention/self/query/kernel",      new tensor(static_cast<void*>(query_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_1/attention/self/query/bias",        new tensor(static_cast<void*>(query_bias), vector<size_t>({6}))},
            {"encoder/layer_1/attention/self/key/kernel",        new tensor(static_cast<void*>(key_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_1/attention/self/key/bias",          new tensor(static_cast<void*>(key_bias), vector<size_t>({6}))},
            {"encoder/layer_1/attention/self/value/kernel",      new tensor(static_cast<void*>(value_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_1/attention/self/value/bias",        new tensor(static_cast<void*>(value_bias), vector<size_t>({6}))},
            {"encoder/layer_1/attention/output/dense/kernel",    new tensor(static_cast<void*>(attention_output_kernel), vector<size_t>({6, 6}))},
            {"encoder/layer_1/attention/output/dense/bias",      new tensor(static_cast<void*>(attention_output_bias), vector<size_t>({6}))},
            {"encoder/layer_1/attention/output/LayerNorm/beta",  new tensor(static_cast<void*>(attention_norm_beta), vector<size_t>({6}))},
            {"encoder/layer_1/attention/output/LayerNorm/gamma", new tensor(static_cast<void*>(attention_norm_gamma), vector<size_t>({6}))},
            {"encoder/layer_1/intermediate/dense/kernel",        new tensor(static_cast<void*>(intermediate_kernel), vector<size_t>({6, 12}))},
            {"encoder/layer_1/intermediate/dense/bias",          new tensor(static_cast<void*>(intermediate_bias), vector<size_t>({12}))},
            {"encoder/layer_1/output/dense/kernel",              new tensor(static_cast<void*>(output_kernel), vector<size_t>({12, 6}))},
            {"encoder/layer_1/output/dense/bias",                new tensor(static_cast<void*>(output_bias), vector<size_t>({6}))},
            {"encoder/layer_1/output/LayerNorm/beta",            new tensor(static_cast<void*>(output_norm_beta), vector<size_t>({6}))},
            {"encoder/layer_1/output/LayerNorm/gamma",           new tensor(static_cast<void*>(output_norm_gamma), vector<size_t>({6}))},
    };
